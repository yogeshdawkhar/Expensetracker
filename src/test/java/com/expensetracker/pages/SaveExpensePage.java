...
public class SaveExpensePage extends BaseClass {

	@FindBy(how = How.XPATH, using = "/html/body/div/h1")
	public WebElement editExpenseHeading;
	...
	public WebElement saveExpenseButton;
	...
	public SaveExpensePage(WebDriver driver) {
		PageFactory.initElements(driver, this);
	}

	public void enterExpenseDetailsAndClickSaveExpense(String day, String month, String year, String category,
	...
	public void enterExpenseDetailsAndClickSaveExpenseWithoutCategory(String day, String month, String year,
			String amount, String reason) {
		enterDay(day);
		enterMonth(month);
		enterYear(year);
	...
	public String getEditExpenseHeading() {
		return editExpenseHeading.getText();
	}
